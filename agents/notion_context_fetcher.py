...
class NotionContextFetcher:
    ...
    SANDBOX_DATABASES: Dict[str, Optional[str]] = {
        ...
        # Fix: IDs were swapped between communautés and espèces in manual selector
        "communautes": "28d6e4d21b4581f4864ac2a5a65f9221",
        "especes": "28d6e4d21b4581c88f48c7aaed8a2803",
        "objets": None,
    }
